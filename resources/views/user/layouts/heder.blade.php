 <header id="header" class="main-header header-fixed fixed-header">
                            ...
                            <div class="inner-header">
                                <div class="inner-header-left">
                                    <div class="logo-box flex">
                                        <div class="logo"><a href="index.html"><img src="" alt="logo" width="166" height="48"></a></div>
                                    </div>
                ...
                <div class="mobile-menu">
                    ...
                    <nav class="menu-box">
                        <div class="nav-logo"><a href="index.html"><img src="{{asset('user/images/logo/logo@2x.png')}}" alt="nav-logo" width="174" height="44"></a></div>
